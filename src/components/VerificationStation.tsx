            ...
            <div>
              ...
              <p className="text-[11px] text-[#3E2340]/70 flex items-center gap-1.5 mt-0.5">
                ...
                {report.detectedBroker && (
                  <span className="text-[#3E2340]/50">• Format: {report.detectedBroker}</span>
                )}
              </p>
            </div>
          </div>
          <span className="text-[10px] font-semibold text-emerald-800 bg-emerald-50 border border-emerald-200 px-2 py-1 rounded-md">
            100 % lokal geprüft
          </span>
        </div>
